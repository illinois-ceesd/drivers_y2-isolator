...
Physical Curve('flow') = {-423, -422, -424, -502, 470, 469, 471};
Physical Curve('wall') = {
//1:211,
1000,
//213:422,
...
Physical Curve('wall_without_injector') = {
//1:211,
1000,
//213:422,
1001,
...
BoundaryLayer Field = 20;

// take the minimum of all defined meshing fields
Field[100] = Min;
Field[100].FieldsList = {2, 3, 4, 5, 6, 7, 8, 12, 14, 112, 114};
