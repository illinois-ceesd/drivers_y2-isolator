...
} = bl_points*scale_fac Using Progression 1.2;
//} = 10;
...
} = 20*scale_fac Using Progression 0.97;

Transfinite Curve {
    bl_long_edges_nozzle_throat[]
} = 30*scale_fac Using Bump 1.4;

Transfinite Curve {
    bl_long_edges_nozzle_outlet[]
} = 42*scale_fac Using Progression 1.01;
...
//Transfinite Curve {
    //bl_long_edges_cavity_upper[]
//} = 38*scale_fac;

//Printf("bl_long_edges_cavity_bottom length = %g", #bl_long_edges_cavity_bottom[]);
//For i In {0:#bl_long_edges_cavity_bottom[]-1}
  //Printf("bl_long_edges_cavity_bottom: %g",bl_long_edges_cavity_bottom[i]);
//EndFor
...
// the upper and lower cavity surfaces have more than 4 corner points
// we'll extract which points we actually want to use for the 
// transfinite algorithm
// upper cavity surface
//For j In {0:#bl_long_surfaces_cavity_upper[]-1}
//
//    isurf = bl_long_surfaces_cavity_upper[j];
//    //Printf("surface %g", isurf);
//    
//    all_points[] = PointsOf{Surface{isurf};};
//    corner_points[] = all_points[];
//    //Printf("all_points length = %g", #all_points[]);
//    For i In {0:#all_points[]-1}
//        //Printf("all_points: %g",all_points[i]);
//    
//        point[]=Point{all_points[i]};
//        If ( (point[0] > x_cavity_start + box_tol ) && (point[0] < x_combustor_start - box_tol) )
//            corner_points[] -= all_points[i];
//        EndIf
//    EndFor
//
//    //Printf("corner_points length = %g", #corner_points[]);
//    //For i In {0:#corner_points[]-1}
//        //Printf("corner_points: %g",corner_points[i]);
//    //EndFor
//
//    Transfinite Surface {isurf} = {corner_points[]};
//EndFor
//
//// lower cavity surface
//For j In {0:#bl_long_surfaces_cavity_lower[]-1}
//
//    isurf = bl_long_surfaces_cavity_lower[j];
//    //Printf("surface %g", isurf);
//    
//    all_points[] = PointsOf{Surface{isurf};};
//    corner_points[] = all_points[];
...
//    
//        point[]=Point{all_points[i]};
//        If ( (point[1] > y_cavity_l + bl_thickness + box_tol ) && (point[1] < y_isolator_bottom + bl_thickness - box_tol) )
//            corner_points[] -= all_points[i];
//        EndIf
//    EndFor
//
...
//EndFor
//
//Transfinite Surface {206} = {608, 610, 628, 627};
...
Transfinite Volume{
    ...
    noz_up_surf_vec_interior_top_bl,
    noz_up_surf_vec_interior_bottom_bl,
    noz_up_surf_vec_interior_aft_bl,
    noz_up_surf_vec_interior_fore_bl
};

Transfinite Volume{
    noz_throat_surf_vec_top_bl_aft_bl,
    noz_throat_surf_vec_bottom_bl_aft_bl,
    noz_throat_surf_vec_top_bl_fore_bl,
    noz_throat_surf_vec_bottom_bl_fore_bl,
    noz_throat_surf_vec_interior_top_bl,
    noz_throat_surf_vec_interior_bottom_bl,
    noz_throat_surf_vec_interior_aft_bl,
    noz_throat_surf_vec_interior_fore_bl
};

Transfinite Volume{
    noz_down_surf_vec_top_bl_aft_bl,
    noz_down_surf_vec_bottom_bl_aft_bl,
    noz_down_surf_vec_top_bl_fore_bl,
    noz_down_surf_vec_bottom_bl_fore_bl,
    noz_down_surf_vec_interior_top_bl,
    noz_down_surf_vec_interior_bottom_bl,
    noz_down_surf_vec_interior_aft_bl,
    noz_down_surf_vec_interior_fore_bl
};
...
//Transfinite Volume{cav_surf_vec_interior_upper_aft_bl[1]} = {572, 618, 619, 572, 590, 588, 546, 560};
...
//interior_wall_surfaces[] = CombinedBoundary { 
//interior_wall_surfaces[] = Boundary { 
//    Volume { 
//        //noz_up_surf_vec_interior,
//        noz_up_surf_vec_interior_aft_bl,
//        noz_up_surf_vec_interior_fore_bl,
...
//};
//
//interior_wall_surfaces[] = Abs(interior_wall_surfaces[]);

//interior_cavity_wall_surfaces[] = CombinedBoundary { 
//interior_cavity_wall_surfaces[] = Boundary { 
//    Volume { 
//        cav_surf_vec_interior_lower_aft_bl[1],
//        cav_surf_vec_interior_lower_fore_bl[1],
//        cav_surf_vec_interior_bottom_bl[1],
...
//};
//
//interior_cavity_wall_surfaces[] = Abs(interior_cavity_wall_surfaces[]);
